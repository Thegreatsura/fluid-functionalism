...
export const componentList: ComponentEntry[] = [
  ...
  { slug: "command-menu", name: "CommandMenu", description: "Type to filter a list of actions, arrow through them, press Enter to run: rows with shortcut caps, groups, suggestions, and a dialog shell on a global shortcut.", isNew: true, gridSize: "medium" },
