...
export const componentList: ComponentEntry[] = [
  ...
  { slug: "card", name: "Card", description: "shadcn's compositional card, dressed in Fluid Functionalism — stacked, inline, and grid layouts, borderless dividers, and 2-D fluid hover.", gridSize: "large" },
  ...
  { slug: "combobox", name: "Combobox", description: "Type-to-filter field with keyboard highlight, fluid hover, and a spring-animated list — items are data, rows are yours.", isNew: true, dotColor: "bg-yellow-400", gridSize: "small" },
  ...
  { slug: "dropdown", name: "Dropdown", description: "Menu-style dropdown with fluid hover, animated backgrounds, and an optional search field inside the popup.", isUpdated: true, dotColor: "bg-yellow-400", gridSize: "small" },
