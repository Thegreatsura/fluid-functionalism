...
export const componentList: ComponentEntry[] = [
  ...
  { slug: "sidebar", name: "Sidebar", description: "Composable app-shell sidebar with offcanvas collapse, floating and inset variants, a mobile sheet, and cookie-persisted state — menu rows carry the proximity-hover traveling highlight.", isNew: true, dotColor: "bg-yellow-500", gridSize: "medium" },
